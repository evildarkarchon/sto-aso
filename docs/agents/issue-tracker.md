...
This clone also has an `upstream` GitHub remote. Target `origin` explicitly with `--repo evildarkarchon/sto-aso` whenever repository resolution could be ambiguous.
